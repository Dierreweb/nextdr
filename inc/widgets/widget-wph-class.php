  ...
  class WPH_Widget extends WP_Widget {
    ...
    */
    ...
    function create_field( $key, $out = "" ) {
      ...
      $key['type'] = $this->dierreweb_change_type( $key['type'] );
    ...
    private function dierreweb_change_type( $key ) {
      switch( $key ) {
        ...
        case 'textarea_html':
          $key = 'textarea';
        break;
        case 'dierreweb_switch':
          $key = 'dropdown';
        break;
        case 'dierreweb_button_set':
          $key = 'dropdown';
        break;
        case 'dierreweb_slider':
          $key = 'dropdown';
        break;
        case 'dierreweb_image_select':
          $key = 'dropdown';
        break;
      }
    ...
    */
    ...
    function create_field_attach_image( $key, $out = "" ) {
      ...
      $out .= '<img src="' . $url . '" class="dierreweb-image-src" style="' . $style . '" />';

      $out .= '<input type="hidden" ';

      if( isset( $key['class'] ) )
        $out .= 'class="dierreweb-image-upload ' . esc_attr( $key['class'] ) . '" ';
      ...
      $out .= '<button class="button dierreweb-image-upload-btn">' . __( 'Upload image', 'dr' ) . '</button>';
