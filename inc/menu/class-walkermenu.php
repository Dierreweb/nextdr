...
if( !class_exists( 'Dierreweb_New_Walker' ) ) {
	Class Dierreweb_New_Walker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$atts = array();
			$atts['title'] = !empty( $item->attr_title ) ? $item->attr_title	: ''; // title over menu
